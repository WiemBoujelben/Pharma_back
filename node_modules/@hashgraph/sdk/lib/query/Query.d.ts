 ...
 */
export function _makePaymentTransaction(paymentTransactionId: TransactionId, nodeId: AccountId, operator: ClientOperator | null, paymentAmount: Hbar): Promise<HieroProto.proto.ITransaction>;
/**
 ...
 */
export default class Query<OutputT> extends Executable<HieroProto.proto.IQuery, HieroProto.proto.IResponse, OutputT> {
    /**
